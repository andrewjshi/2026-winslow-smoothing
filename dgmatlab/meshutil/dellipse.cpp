...
void roots(double *pol,double *rr,double *ri,mwSize n);
...
extern "C" { void dhseqr_(char*,char*,mwSize*,mwSize*,mwSize*,double*,mwSize*,double*,
                         double*,void*,mwSize*,double*,void*,mwSize*); }
